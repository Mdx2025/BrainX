...
Commands:
  ...
  inject --query <text> [--limit <n>] [--context <ctx>] [--tier <tier>] [--minImportance <n>] [--minScore <n>] [--maxTotalChars <n>] [--maxCharsPerItem <n>] [--maxLinesPerItem <n>] [--maxSensitivity <normal|sensitive|restricted>]
